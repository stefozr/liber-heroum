...
const ASPECT_ABILITY_9 = {
  ...
  reaver: [
    fe(11, 'Primordial Bane', 'You attune the target to be weaker to a specific element.', 'Choose acid, cold, corruption, fire, lightning, poison, or sonic damage. The target loses any damage immunity to the chosen type and gains weakness 10 to the chosen type (save ends).', { keywords:['Magic','Melee','Strike','Weapon'], powerRoll:'Might', tiers:tr('11 + M','16 + M','21 + M') }),
  ...
  stormwight: [
    ...
    fe(11, 'Deluge', 'You summon your primordial storm.', 'This ability deals your primordial damage type and ignores damage immunity.', { keywords:['Area','Magic','Ranged'], type:'Main action', distance:'5 cube within 10', target:'Each enemy in the area', powerRoll:'Might', tiers:tr('7','10','15') }),
  ],
};
