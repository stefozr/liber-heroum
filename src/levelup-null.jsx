...
const DIS_7 = () => [
  ...
  dis(7, 'Molecular Rearrangement Field', 'Your enemies’ wounds open, your allies’ wounds close.', 'Until the end of the encounter, the size of your Null Field abil ity increases by 1. While the area of that ability is enlarged this way, each enemy who has I < AVERAGE and enters the area for the first time in a combat round or starts their turn there is bleeding (save ends). Each ally who enters the area for the first time in a combat round or starts their turn there gains temporary stamina equal to your Intuition score.', { type:'Maneuver', keywords:['Psionic'], distance:'Self', target:'Self' }),
...
const DIS_11 = () => [
  ...
  dis(11, 'Phase Hurl', 'You throw your foe out of phase with this manifold, causing them to harm other enemies as they return.', 'The target and each creature or object they collide with from this forced movement takes 1 psychic damage psychic damage equal to the total number of squares the target was force moved. While the target is dazed this way, they see glimpses of creatures from other parts of the timescape.', { tiers:t('9 + A damage; push 5; I < WEAK, dazed (save ends)','13 + A damage; push 7; A < AVERAGE, dazed (save ends)','18 + A damage; push 10; A < STRONG, dazed (save ends)') }),
...
const TRAD_ABILITY_2 = {
  ...
  metakinetic: [
    ...
    dis(5, 'Kinetic Shield', 'You manifest a force barrier that absorbs incoming kinetic energy.', 'While you have temporary Stamina from this ability, you can’t be made bleeding even while dying.\n\n10 temporary Stamina 15 temporary Stamina 20 temporary Stamina\n\nBleeding Immunity.', { tiers: [['≤11','You gain 10 temporary Stamina'],['12–16','You gain 15 temporary Stamina'],['17+','You gain 20 temporary Stamina']], type:'Maneuver', keywords:['Psionic'], distance:'Self', target:'Self' }),
  ],
};
...
export const nul = {
  ...
  4: {
    ...
    autoFeatures: () => [
      ...
      { name: 'Discipline Mastery Improvement I', text: 'Your Discipline Mastery feature provides additional benefits when you have 8 or more discipline.' },
  ...
  7: {
    ...
    autoFeatures: () => [
      ...
      { name: 'Discipline Mastery Improvement II', text: 'Your Discipline Mastery feature provides additional benefits when you have 10 or more discipline.' },
  ...
  10: {
    ...
    autoFeatures: () => [
      ...
      { name: 'Discipline Mastery Improvement III', text: 'Your Discipline Mastery feature provides additional benefits when you have 12 or more discipline.' },
