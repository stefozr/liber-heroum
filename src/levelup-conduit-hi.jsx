...
const PI_11 = () => [
  ...
  pi(11, 'Blessing of Steel', 'A protective aura defends your allies from harm.', 'Until the end of the encounter, any ability roll made against a target takes a bane and each target has damage immunity 5.', { type: 'Maneuver', keywords:['Area','Magic'], distance:'5 aura', target:'Self' }),
