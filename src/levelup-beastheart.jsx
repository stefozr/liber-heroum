...
const WILD_FEAT_2 = {
  ...
  punisher: [{ name: 'This One’s Yours', text: 'You end the forced movement. You can then push the creature up to a number of squares equal to 1 + your Might score. The creature takes 1 damage for each square they are force moved this way.' }],
...
const WILD_FEAT_8 = {
  guardian: [{ name: 'Reflexes Perfected', text: 'Your and your companion\'s free strikes deal extra damage equal to your Intuition score. Whenever an adjacent enemy moves to a space that isn\'t adjacent, you or your companion can make an opportunity attack, even if the enemy shifted, teleported, was force moved, or another feature that doesn\'t provoke opportunity attacks.' }],
...
const WILD_ABILITY_2 = {
  guardian: [
    fer(5, 'Fetch!', 'Your companion blinks out of existence, returning with a visitor you were particularly hoping to meet.', 'Your companion can teleport up to 5 squares before and after making the power roll. Instead of grabbing the target, your companion can pick up a target object that is smaller than they are. You can forgo dealing damage with this ability.', { keywords:['Companion','Magic','Melee','Strike','Weapon'], target:'One creature or object', powerRoll:'Might', tiers:t('6 + M damage; M < WEAK, grabbed','8 + M damage; M < AVERAGE, grabbed','12 + M damage; M < STRONG, grabbed') }),
    fer(5, 'Omnomnom', 'What do you have in your mouth? No! Bad boy!', '**Special:** This ability targets only creatures who are grabbed and are your companion\'s size or smaller.\n\nA swallowed creature shares your companion\'s space, is grabbed and restrained, and has line of effect only to your companion. Nothing has line of effect to the swallowed creature.', { keywords:['Companion','Melee','Strike','Weapon'], powerRoll:'Might', tiers:t('6 + M damage; M < WEAK, the target is swallowed','10 + M damage; M < AVERAGE, the target is swallowed','14 + M damage; M < STRONG, the target is swallowed') }),
  ],
  prowler: [
