...
import { Wizard, isStepValid, stepIssues, classSections, wizardProgress } from './wizard/Wizard.jsx';
import { PERKS } from './wizard/helpers.js';

Object.assign(window, { Wizard, PERKS });
export { Wizard, isStepValid, stepIssues, classSections, wizardProgress, PERKS };
