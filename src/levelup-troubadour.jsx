...
const DRAMA_11 = [
  ...
  { name: 'The Show Must Go On', cost: 11, resource: 'Drama', flavor: 'You shine a bright light on the players on the stage and compel them to finish the performance.', keywords: ['Area','Magic','Ranged'], type: 'Maneuver', distance: '5 cube within 10', target: 'Each enemy in the area', powerRoll: 'Presence', tiers: t('6 damage; P < WEAK, the target can\'t willing leave the area (EoT)','8 damage; P < AVERAGE, the target can\'t willing leave the area (save ends)','12 damage; the target can\'t willingly leave the area (EoT); if P < STRONG, they can\'t willing leave the area (save ends)'), effect: 'Each ally within distance can’t obtain lower than a tier 2 outcome on the next test they make before the start of your next turn.' },
];
