...
const CL_7 = () => [
  ...
  cl(7, 'Force Orbs', 'Spheres of solid psionic energy float around you.', 'You create three size 1T orbs that orbit your body. Each orb gives you a cumulative damage immunity 1. Each time you take damage, you lose 1 orb.', { strained: 'You create five orbs, and you are weakened while you have any orbs active.', target: 'Self', distance: 'Self; see below', keywords:['Psionic','Ranged','Strike','Telekinesis'], powerRoll:'Reason', tiers:tr('2 damage','3 damage','5 damage') }),
...
const CL_11 = () => [
  ...
  cl(11, 'Rejuvenate', 'You reshape the flow of time in the target’s body to return it to an earlier state.', 'Choose two of the following effects:', { strained: 'You and the target both permanently grow visibly younger (the equivalent of 20 human years, to the minimum of an 18-year-old). Additionally, you are weakened and slowed (save ends).', type: 'Maneuver', keywords:['Psionic','Ranged','Chronopathy'], target:'Self or one ally' }),
