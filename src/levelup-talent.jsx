...
const CL_7 = () => [
  ...
  cl(7, 'Soul Burn', 'You blast their soul out of their body, leaving it to helplessly float back to a weakened husk.', 'The target takes a bane on Presence tests until the end of the encounter.\n\n**Strained:** The potency of this ability increases by 1. You take 2d6 damage and gain 3 surges that you can use immediately.', { keywords:['Psionic','Ranged','Strike','Animapathy'], powerRoll:'Presence', tiers:tr('6 + P damage; P < WEAK, dazed (save ends)','10 + P damage; P < AVERAGE, dazed (save ends)','14 + P damage; P < STRONG, dazed (save ends)') }),
];
const CL_9 = () => [
...
const CL_11 = () => [
  ...
  cl(11, 'Steel', 'The target’s skin becomes covered in tough metal.', 'The target has damage immunity 5 and can’t be made slowed or weakened until the start of your next turn. Whenever the target force moves a creature or object while under this effect, the forced movement distance gains a +5 bonus.\n\n**Strained:** You can’t use maneuvers (save ends).', { type: 'Maneuver', keywords:['Psionic','Ranged','Metamorphosis'], target:'Self or one ally' }),
];
