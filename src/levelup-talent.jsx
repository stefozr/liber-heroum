...
const CL_7 = () => [
  cl(7, 'Fling Through Time', 'You hurl the target through the annals of time, forcing them to witness every moment of their existence all at once.', 'A target who is flung through time is removed from the encounter map until the end of their next turn, reappearing in their original space or the nearest unoccupied space.\n\n**Strained:** You take 2d6 damage and permanently grow visibly older (the equivalent of 10 years for a human). If you obtain a tier 3 outcome on the power roll, you gain 2 clarity.', { target: 'One creature or object', keywords:['Psionic','Ranged','Strike','Chronopathy'], powerRoll:'Presence', tiers:tr('3 + P corruption damage; P < WEAK, weakened (save ends)','5 + P corruption damage; the target is flung through time and if P < AVERAGE, they are weakened (save ends)','8 + P corruption damage; P < STRONG, weakened (save ends)') }),
  cl(7, 'Force Orbs', 'Spheres of solid psionic energy float around you.', 'You create three size 1T orbs that orbit your body. Each orb gives you a cumulative damage immunity 1. Each time you take damage, you lose 1 orb.\n\nOnce on each of your turns, you can use a free maneuver to fire an orb at a creature or object within 5 squares as a ranged strike, losing the orb after the strike.\n\nYou create five orbs, and you are weakened while you have any orbs active.', { target: 'Self', distance: 'Self', keywords:['Psionic','Ranged','Strike','Telekinesis'], powerRoll:'Reason', tiers:tr('2 damage; R < WEAK','3 damage; R < AVERAGE','5 damage; R < STRONG') }),
  cl(7, 'Reflector Field', 'A protective field reverses the momentum of incoming attacks.', 'The aura lasts until the start of your next turn. Whenever an enemy targets an ally in the area with a ranged ability, the ability is negated on the ally and reflected back at the enemy. The ability deals half the damage to the enemy that it would have dealt to the ally and loses any additional effects.\n\n**Strained:** The size of the aura increases by 1. Whenever your aura reflects an ability, you take 2d6 damage and forget a memory, as determined by you and the Director.', { keywords:['Area','Psionic','Telepathy'], type:'Main action', distance:'3 aura', target:'Special' }),
  cl(7, 'Soul Burn', 'You blast their soul out of their body, leaving it to helplessly float back to a weakened husk.', 'The target takes a bane on Presence tests until the end of the encounter.\n\n**Strained:** The potency of this ability increases by 1. You take 2d6 damage and gain 3 surges that you can use immediately.', { keywords:['Psionic','Ranged','Strike','Animapathy'], powerRoll:'Presence', tiers:tr('6 + P damage; P < WEAK, dazed (saved ends)','10 + P damage; P < AVERAGE, dazed (saved ends)','14 + P damage; P < STRONG, dazed (saved ends)') }),
];
const CL_9 = () => [
  cl(9, 'Exothermic Shield', 'You encase the target in psionic flame and allow them to flicker with- out fear of burning out.', 'Until the start of your next turn, the target has cold immunity 10 and fire immunity 10, and their strikes deal extra fire damage equal to twice your Reason score. Additionally, whenever an enemy uses a melee ability against the target while they are under this effect, the enemy takes 5 fire damage.\n\n**Strained**: The target gains 2 surges. You are weakened and slowed (save ends).', { type: 'Maneuver', keywords:['Psionic','Ranged','Pyrokinesis'], target:'Self or one ally' }),
  cl(9, 'Hypersonic', 'You move fast enough to turn around and watch your foes feel the aftermath.', 'You teleport to a square on the opposite side of the area before making the power roll.\n\nIf you obtain a tier 2 outcome or better, you are slowed until the end of your turn and each target is slowed until the end of their turn.', { distance: '5 × 2 line within 1', keywords:['Area','Charge','Psionic','Telekinesis'], target:'Each enemy in the area', powerRoll:'Reason', tiers:tr('12 sonic damage','18 sonic damage','24 sonic damage') }),
  cl(9, 'Mind Snare', 'You latch onto your prey’s brain and don’t let go, like a song they can’t get out of their head.', 'While slowed this way, the target takes 3 psychic damage for each square they willingly leave.\n\n**Strained**: While slowed this way, the target instead takes 5 psychic damage for each square they willingly leave. You have a double bane on ability rolls made against the target while they are slowed this way.', { keywords:['Psionic','Ranged','Strike','Telepathy'], powerRoll:'Reason', tiers:tr('10 + R psychic damage; R < WEAK, slowed (save ends)','14 + R psychic damage; R < AVERAGE, slowed (save ends)','20 + R psychic damage; R < STRONG, slowed (save ends)') }),
  cl(9, 'Soulbound', 'You fire a piercing bolt of psychic energy that lances through two foes and leaves a faint intangible thread between them.', 'If any target becomes stitched to the other, both targets are stitched together. While stitched together, a target takes a bane on power rolls while not adjacent to a creature they’re stitched to.\n\nWhenever a stitched target takes damage that wasn’t dealt by or also taken by another stitched target, each other stitched target takes half the damage the initial target took.\n\n**Strained**: You target yourself and three enemies instead.', { keywords:['Psionic','Ranged','Strike','Animapathy'], target:'Two enemies', powerRoll:'Presence', tiers:tr('8 damage; A < WEAK, stitched (save ends)','13 damage; A < AVERAGE, stitched (save ends)','17 damage; A < STRONG, stitched (save ends)') }),
];
const CL_11 = () => [
  cl(11, 'Doubt', 'You tug at the strings of the foe’s anima and unravel them, allowing someone else to take advantage of their drive.', 'This ability gains an edge against a target with a soul. After you make the power roll, you or one ally within distance have a double edge on the next power roll you make before the end of the encounter.\n\nYou feel dispirited until you finish a respite. If you obtain a tier 3 outcome on the power roll, you and the target each have damage weakness 5 (save ends).', { target: 'One creature or object', keywords:['Psionic','Ranged','Strike','Animapathy'], powerRoll:'Presence', tiers:tr('10 + P damage; P < WEAK, weakened (save ends)','14 + P damage; P < AVERAGE, weakened (save ends)','20 + P damage; P < STRONG, weakened and slowed (save ends)') }),
  cl(11, 'Mindwipe', 'You attempt to make them forget all their training.', 'The target can’t communicate with anyone until the end of the encounter.\n\nYou take 3d6 damage.', { keywords:['Melee','Psionic','Strike','Telepathy'], distance:'Melee 2', powerRoll:'Reason', tiers:tr('12 + R damage; R < WEAK, the target takes a bane on their next power roll','17 + R damage; R < AVERAGE, the target takes a bane on power rolls (save ends)','23 + R damage; R < STRONG, the target has a double bane on power rolls (save ends)') }),
  cl(11, 'Rejuvenate', 'You reshape the flow of time in the target’s body to return it to an earlier state.', 'Choose two of the following effects:\n\n- The target can spend any number of Recoveries.\n- The target gains 1 of their Heroic Resource, and can end any effects on them that are ended by a saving throw or that end at the end of their turn.\n- The target gains 2 surges, and gains a +3 bonus to speed until the end of the encounter. **Strained:** You and the target both permanently grow visibly younger (the equivalent of 20 human years, to the minimum of an 18-yearold). Additionally, you are weakened (save ends) and slowed (save ends).', { type: 'Maneuver', keywords:['Psionic','Ranged','Chronopathy'], target:'Self or one ally' }),
  cl(11, 'Steel', 'The target’s skin becomes covered in tough metal.', 'The target has "Damage and can’t be made slowed or weakened until the start of your next turn. Whenever the target force moves a creature or object while under this effect, the forced movement distance gains a +5 bonus.\n\n**Strained:** You can’t use maneuvers (save ends).', { type: 'Maneuver', keywords:['Psionic','Ranged','Metamorphosis'], target:'Self or one ally' }),
];
...
const TRAD_ABILITY_2 = {
  chronopathy: [
    ...
    cl(5, 'Slow', 'Perhaps they wonder why everyone else is moving so quickly?', 'A target can’t use triggered actions while their speed is reduced this way.\n\n**Strained:** The potency of this ability increases by 1 and you take 1d6 damage. At the start of each combat round while any target is affected by this ability, you take 1d6 damage. You can end the effect on all affected targets at any time (no action required).', { keywords: ['Psionic','Ranged','Chronopathy'], type:'Maneuver', target:'Three creature or objects', powerRoll:'Presence', tiers:tr('The target’s speed is halved (save ends), or if P < WEAK, the target is slowed (save ends).','The target’s is slowed (save ends), or if P < AVERAGE, the target\'s speed is 0 (save ends).','The target’s speed is halved (save ends), or if P < STRONG, the target is slowed (save ends).') }),
  ],
  telekinesis: [
    cl(5, 'Gravitic Burst', 'Everyone get away from me!', '**Strained:** The size of the burst increases by 1, and you are weakened until the end of your turn.', { keywords:['Area','Psionic','Telekinesis'], distance:'1 burst', target:'Each enemy in the area', powerRoll:'Reason', tiers:tr('3 damage; vertical push 2','6 damage; vertical push 4','9 damage; vertical push 6') }),
    cl(5, 'Levity and Gravity', 'You raise the target slightly into the air, then smother them against the ground.', '**Strained:** You take half the damage the target takes.', { target: 'One creature or object', keywords:['Psionic','Ranged','Strike','Telekinesis'], powerRoll:'Reason', tiers:tr('6 + R damage; M < WEAK, prone','10 + R; M<AVERAGE prone','14 + R; M<STRONG prone & can\u2019t stand (save)') }),
  ],
  telepathy: [
    cl(5, 'Overwhelm', 'You overload their senses, turning all their subconscious thoughts into conscious ones.', '**Strained:** You start crying, and you can’t use triggered actions or make free strikes until the end of the target’s next turn.', { keywords:['Psionic','Ranged','Strike','Telepathy'], powerRoll:'Reason', tiers:tr('6 + R psychic damage; I < WEAK, slowed (save ends)','10 + R psychic; I<AVERAGE weakened (save)','14 + R psychic; I<STRONG dazed (save)') }),
    cl(5, 'Synaptic Override', 'You control an enemy’s nervous system. How pleasant for them.', 'You control the target’s movement. The target can’t be moved in a way that would harm them (such as over a cliff), leave them dying, or result in them suffering a condition or other negative effect. However, you can move them to provoke opportunity attacks.\n\n**Strained:** You take 1d6 damage and are weakened until the end of your turn.', { type:'Main action', keywords:['Psionic','Ranged','Telepathy'], target:'One enemy', powerRoll:'Reason', tiers:tr('The target makes a free strike against one enemy of your choice.','The target shifts up to their speed and uses their signature ability against any enemies of your choice.','The target moves up to their speed and uses their signature ability against any enemies of your choice.') }),
  ],
};
const TRAD_ABILITY_6 = {
  chronopathy: [
    cl(9, 'Fate', 'Your foe gets a glimpse of how it will end for them.', 'The target has "Damage until the end of your next turn. Whenever the target takes damage while they have this weakness, they are knocked prone.\n\nThis ability gains the Strike keyword as the vision hurts the target’s psyche. You make a power roll, then are weakened (save ends).', { tiers: [['≤11','8 + P psychic damage'],['12–16','13 + P psychic damage'],['17+','17 + P psychic damage']], keywords:['Melee','Psionic','Chronopathy'], distance:'Melee 2', target:'One enemy' }),
    cl(9, 'Stasis Field', 'Keep everything as it was. Ignore everything that will be.', 'The area is frozen in time until the start of your next turn. Each object in the area is restrained and can’t fall until the effect ends. Until the effect ends, creatures in the area who are reduced to 0 Stamina or would die stay alive, and objects in the area that are reduced to 0 Stamina remain undestroyed.\n\nMake a power roll that targets each enemy in the area.\n\nAny creature or object force moved in the area takes 2 corruption damage for each square of the area they enter. Creatures and objects restrained in the area can be force moved. You are restrained until the effect ends.', { keywords:['Area','Psionic','Ranged','Chronopathy'], distance:'4 cube within 10', target:'Each creature or object in the area', powerRoll:'Presence', tiers:tr('P < WEAK, the target is slowed until the effect ends','P < AVERAGE, the target’s speed is 0 until the effect ends','P < STRONG, the target is restrained until the effect ends') }),
  ],
  telekinesis: [
    cl(9, 'Gravitic Well', 'You bend gravity into a fine point and pull your foes toward it.', 'Targets closest to the center of the area are pulled first.\n\nThe size of the area increases by 2. You also target yourself and each ally within distance.', { keywords:['Area','Psionic','Ranged','Telekinesis'], distance:'4 cube within 10', target:'Each enemy or object in the area', powerRoll:'Reason', tiers:tr('6 damage; vertical pull 5 toward the center of the area','9 damage; vertical pull 7 toward the center of the area','13 damage; vertical pull 10 toward the center of the area') }),
    cl(9, 'Greater Kinetic Grip', 'You raise the target into the air without breaking a sweat.', 'The forced movement ignores stability. You take 2d6 damage and are weakened (save ends).', { keywords:['Psionic','Ranged','Strike','Telekinesis'], target:'One creature or object', powerRoll:'Reason', tiers:tr('slide 4 + @chr M < WEAK, the forced movement is vertical','slide 8 + @chr R < AVERAGE, the forced movement is vertical','slide 12 + @chr R < STRONG, the forced movement is vertical') }),
  ],
  telepathy: [
...
const TRAD_ABILITY_9 = {
  chronopathy: [
    cl(11, 'Acceleration Field', 'You forcibly stuff more moments into a critical point in time, knowing full well you might need to steal some of your own.', 'Each target can use any main action available to them as a free triggered action, but they lose their main action on their next turn.\n\nMake a power roll that targets you and each enemy within distance.', { tiers: [['≤11','4 corruption damage; slowed (save ends)'],['12–16','6 corruption damage; slowed (save ends)'],['17+','10 corruption damage; slowed (save ends)']], keywords:['Psionic','Ranged','Chronopathy'], distance:'Ranged 5', target:'Three allies' }),
    cl(11, 'Borrow From the Future', 'You lean on future heroism to assist you in the now.', 'The targets share 6 of their Heroic Resource among themselves, as you determine. A target can’t gain more than 3 of their Heroic Resource this way. After using this ability, you can’t gain any clarity until the end of the next combat round.\n\ngains 1 of their Heroic Resource gains 2 of their Heroic Resource gains 3 of their Heroic Resource.', { type:'Maneuver', keywords:['Area','Psionic','Chronopathy'], distance:'2 burst', target:'Each ally in the area' }),
  ],
  telekinesis: [
    cl(11, 'Fulcrum', 'You precisely manipulate the creatures around you.', 'Make a power roll to determine the area of this ability. Each target is vertical pushed 6 squares. You can target only objects of size 1L or smaller\n\nYou can choose to reduce the size of the burst by 2 (to a minimum of 1 burst) to give the forced movement distance a +2 bonus. You take half the total damage all targets take from forced movement.', { keywords:['Area','Psionic','Telekinesis'], distance:'Special', target:'Each enemy or object', powerRoll:'Reason', tiers:tr('2 burst','3 burst','4 burst') }),
    cl(11, 'Gravitic Nova', 'Unbridled psionic energy erupts from your body and flashes outward, hurling your foes back.', 'On a critical hit, the size of the area increases by 3, and this ability deals an extra 10 damage.\n\n**Strained:** You are weakened (save ends). If you scored a critical hit with this ability, you die.', { keywords:['Area','Psionic','Telekinesis'], distance:'3 burst', target:'Each enemy or object in the area', powerRoll:'Reason', tiers:tr('6 damage; push 7','9 damage; push 10','13 damage; push 15') }),
  ],
  telepathy: [
    cl(11, 'Resonant Mind Spike', 'You fire a telepathic bolt empowered by every consciousness within reach directly into your foe’s mind.', 'This ability ignores cover and concealment.\n\nThe ability roll scores a critical hit on a natural 17 or higher. You take half the damage the target takes, and you can’t reduce this damage in any way.', { keywords:['Psionic','Ranged','Strike','Telepathy'], powerRoll:'Reason', tiers:tr('15 + R psychic damage','24 + R psychic damage','28 + R psychic damage') }),
